...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = 'discuzdb.cdhe7heljzkn.us-west-2.rds.amazonaws.com';
$_config['db']['1']['dbuser'] = 'root';
$_config['db']['1']['dbpw'] = 'saysomething';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'ytfA_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = '906331t6LKUDzumP';
